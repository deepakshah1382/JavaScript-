...
function arryaIteam(array, callback) {
  for (let i = 0; i < array.length; i++) {
    let final = callback(array[i]);
    if (final) {
...
let result = arryaIteam([2, 3, 6, 6, 9, 3], (value, index) => {
  if (value === 9) {
    return value;
  }
});
...
let arrys = ["one", "two", "three", "four"];
for (let i = 0; i < arrys.length; i++) {
  // console.log(arrys[i], i);
}

//  now i am trying to access only  the the string Datatype values only
function Datatype(arrys, callback) {
  for (let i = 0; i < arrys.length; i++) {
    let final = callback(arrys[i], i);
    if (final) {
      console.log(arrys[i]);
    }
  }
}
Datatype(["", 1, "two", 2, "three", 3], (value, index) => {
  if (typeof value === "string") {
    return true;
  }
});

//  now i want to address the all the element
// print element in arrys
// secode arrys allos in the arrys
//  last element print in  the uppercase

// function proicess(array, callback) {
//   let result = [];
//   for (let i = 0; i < array.length; i++) {
//     result.push(`index: ${i} ||element: ${array[i]}`);
//   }
//   return result;
// }
// let array = [1, 2, 3, 4, 5, 6];
// let call = proicess(array, (value, index) => {
//   console.log(value * 2, index);
// });
// console.log(call);

//  now i am trying to uppercase  an output give me in the uppercase
// function processEevent(arrys, callback, callback2) {
//   for (let i = 0; i < arrys.length; i++) {
//     let result = callback(arrys[i]);
...
// let final = processEevent(
//   ["Deepak", 1, "suraj", 2, "gorvav", 3, "this", 4],
//   (value, index) => {
//     if (typeof value === "string") {
//       return value;
//     }
